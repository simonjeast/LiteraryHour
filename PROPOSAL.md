# Proposal: Literary Time Landing Page

## Client Brief

**Client:** Sarah (Wellesley College student, English major)

**Purpose:** Create a one-page literary clock that feels calm and artistic, and encourages quick reading breaks.

**Audience:** Students and friends who open the page for a visual pause and a quote they can read further.
...
- Scenic color backgrounds that rotate with quotes
- Serif typography for a literary feel
- Soft panel overlay for contrast

**Inspiration sites:**
- https://www.brainyquote.com/ - client liked easy quote scanning
- https://www.goodreads.com/quotes - client liked source-oriented reading behavior
- https://www.poetryfoundation.org/ - client liked calm, text-first presentation
